...
export default function ProfileSetup() {
  ...
  if (alreadyComplete) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        <div
          className={`w-full max-w-lg bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-500 ${
  ...
  return (
    <div className="min-h-screen bg-green-950 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div
        className={`relative z-10 w-full max-w-[520px] bg-white rounded-3xl shadow-2xl overflow-hidden transition-all duration-500 ${
        ...
        <div className="px-9 py-8">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <button
                    ...
                    className={`relative text-center p-6 rounded-2xl border-2 transition-all duration-150 ${
                      form.role === r.value
          ...
          <div className="flex gap-3 mt-7">
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 rounded-full py-3 text-[14px] font-semibold text-white transition-all ${
                !canProceed() || loading
